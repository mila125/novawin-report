...
exported_file_path = f"{path_csv}\\NKA_{fecha_str}.csv"
...
if main_window.exists():
    ...
    try:
        ...
        nk_menu_item = fdm_menu_item.child_window(title="NK Method Fractal Dimension(Adsorption )", control_type="MenuItem")
