...
input_file = input("Por favor, ingresa la ruta del archivo con datos exportados (CSV o TXT): ")
output_file = input("Por favor, ingresa la ruta completa donde deseas guardar el gráfico en PDF (incluye el nombre y .pdf): ")
