...
exported_file_path = f"{path_csv}\\FFHD_{fecha_str}.csv"
...
if main_window.exists():
    ...
    try:
        ...
        # Seleccionar "FHH Method Fractal Dimension(Desorption )"
        ...
        ffhd_menu_item = fdm_menu_item.child_window(title="FHH Method Fractal Dimension(Desorption )", control_type="MenuItem")
        ffhd_menu_item.click_input()

        print("Se seleccionó 'FHH Method Fractal Dimension(Desorption )' exitosamente.")
        secondary_window2 = app.window(title_re=f".*tab:FHH Method Fractal Dimension(Desorption ): file_to_open_nameonly.*")
