...
exported_file_path = f"{path_csv}\\NKD_{fecha_str}.csv"
...
if main_window.exists():
    ...
    try:
        ...
        # Seleccionar "NK Method Fractal Dimension(Desorption)"
        ...
        nk_menu_item = fdm_menu_item.child_window(title="NK Method Fractal Dimension(Desorption )", control_type="MenuItem")
        nk_menu_item.click_input()

        print("Se seleccionó 'NK Method Fractal Dimension(Desorption )' exitosamente.")
        secondary_window2 = app.window(title_re=f".*tab:NK Method Fractal Dimension(Desorption ): file_to_open_nameonly.*")
